# TOOLS.md — Local Notes (Prism)

Environment notes specific to this specialist. Keep it short; update as you learn.

## Environment
- Workspace: ~/.openclaw/workspace/subagents/data-analyst (this folder).
...
- MCP servers: openclaw.json (`mcp.servers`) is the source of truth. Recommended for this role:
  Postgres / warehouse, Airtable (see the project README — install your own).
