# TOOLS.md — Local Notes (Sentinel)

Environment notes specific to this specialist. Keep it short; update as you learn.

## Environment
- Workspace: ~/.openclaw/workspace/subagents/compliance (this folder).
...
- MCP servers: openclaw.json (`mcp.servers`) is the source of truth. Recommended for this role:
  web search, policy / legal DB (see the project README — install your own).
