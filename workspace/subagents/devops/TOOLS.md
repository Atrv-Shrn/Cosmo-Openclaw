# TOOLS.md — Local Notes (Wrench)

Environment notes specific to this specialist. Keep it short; update as you learn.

## Environment
- Workspace: ~/.openclaw/workspace/subagents/devops (this folder).
...
- MCP servers: openclaw.json (`mcp.servers`) is the source of truth. Recommended for this role:
  GitHub, Docker, cloud CLI, monitoring (see the project README — install your own).
