# TOOLS.md — Local Notes (Scout)

Environment notes specific to this specialist. Keep it short; update as you learn.

## Environment
- Workspace: ~/.openclaw/workspace/subagents/sales-lead-scraper (this folder).
...
- MCP servers: openclaw.json (`mcp.servers`) is the source of truth. Recommended for this role:
  LinkedIn / Apollo, web search (see the project README — install your own).
