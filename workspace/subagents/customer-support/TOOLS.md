# TOOLS.md — Local Notes (Patch)

Environment notes specific to this specialist. Keep it short; update as you learn.

## Environment
- Workspace: ~/.openclaw/workspace/subagents/customer-support (this folder).
...
- MCP servers: openclaw.json (`mcp.servers`) is the source of truth. Recommended for this role:
  Zendesk / Intercom, Gmail (see the project README — install your own).
